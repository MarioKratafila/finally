...
You are using a different AI Agent to carry out a review of the document: planning/PLAN.md. You must execute the following shell command to carry out the review - do not review yourself:
