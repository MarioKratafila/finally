...
<reference>
@C:/Users/krata/Repositories/finally/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Users/krata/Repositories/finally/.claude/get-shit-done/references/user-profiling.md` to load:
