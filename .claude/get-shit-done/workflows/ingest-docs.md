...
```bash
INIT=$(node "C:/Users/krata/Repositories/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/krata/Repositories/finally/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
