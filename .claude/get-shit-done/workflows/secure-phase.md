...
```
Agent(
  prompt="Read C:/Users/krata/Repositories/finally/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/krata/Repositories/finally/.claude/get-shit-done/templates/SECURITY.md`
